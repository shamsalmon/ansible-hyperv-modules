            ...
            <UserAccounts>
                ...
                <LocalAccounts>
                    <LocalAccount wcm:action="add">
                        ...
                        <DisplayName>Ansible Local Admin</DisplayName>
                        <Name>ansible_local</Name>
...
'@
    ...
    $encodedUserPassword = [System.Text.Encoding]::Unicode.GetBytes($AdministratorPassword + 'Password')
    $xml.unattend.settings[1].component.UserAccounts.AdministratorPassword.Value = [Convert]::ToBase64String($encodedPassword)
    $xml.unattend.settings[1].component.UserAccounts.LocalAccounts.LocalAccount.Password.Value = [Convert]::ToBase64String($encodedUserPassword)
...
Export-ModuleMember -Function New-WindowsUnattendFile